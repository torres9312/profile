...
window.addEventListener('scroll', function(){
	...
	text.style.top = value * .40 + 'px';
	text.style.opacity = (280 - value) / 100;
})
...
var onePageNavigation = function() {
  var navToggler = $('.site-menu-toggle');
 	$("body").on("click", ".unslate_co--site-nav .site-nav-ul li a[href^='#'], .smoothscroll[href^='#'], .unslate_co--site-mobile-menu .site-nav-wrap li a[href^='#'], a.link-section", function(e) {
	...
	$.ajax({
		...
		success: function(html) {
			...
			pSingleHolder.append(
				...
				'" class="portfolio-single-inner"><span class="unslate_co--close-portfolio js-close-portfolio d-flex align-items-center"><span class="close-portfolio-label">Cerrar Proyecto</span><span class="icon-close2 wrap-icon-close"></span></span>' + getHTMLContent + '</div>'
			);
